<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GM001.aspx.cs" Inherits="GGFGAMA.GAMA.GM001" %>
...
<%--                            <h4>地區</h4>
                ...
                <div class="col-md-10">
                    <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Height="768px" Width="1024px" Visible="False" >
                        <LocalReport ReportPath="GAMA\Report\工段匯入.rdlc" DisplayName="出口大表">
                        </LocalReport>
                    </rsweb:ReportViewer>
                </div>
            </div>
